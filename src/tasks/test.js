...
// Wraps `TASK_TEST` so `npx hardhat test` auto-spawns a TRE
// container before tests run and tears it down after, when the
// configured network is tron-typed AND `tre.autoStart` is true.
//
// Skip cases (no spawn):
//   * tre.autoStart === false
